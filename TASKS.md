...
6. **Рефакторинг метода авторизации (3.8)** - упростить вложенность и переименовать receiveLoop ← **СЛЕДУЮЩАЯ**
7. **Добавить комментарии в TDLibAdapter (3.4)** - делать после рефакторинга метода авторизации
