...
- **Перевод на русский язык:**
  ...
  - Файлы: AuthenticationFlowTests, ResponseDecodingTests, UserTests, TDLibRequestEncoderTests, TDLibUpdateTests

- **GitHub ссылки:** Каждый тестовый файл содержит clickable ссылку на исходный код

- **Парсинг комментариев из тела теста:** Given/When/Then автоматически извлекаются и добавляются в документацию

### Изменено

- `README.md`: добавлена секция "Установка TDLib" с инструкциями для macOS и Linux (в спойлерах)
- `Documentation.swift`: перевод на русский + ссылка на опубликованную документацию
- `TgClient.md`: упрощена главная страница документации

### Следующий этап

**DEV-4.2:** Автоссылки на Request/Response типы + Backlinks (запланировано)
