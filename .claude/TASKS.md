...
### 🐛 КРИТИЧНЫЙ BUGFIX v0.3.0: Архивные каналы в дайджесте

**Статус:** ⏳ В процессе (Шаги 1-4 завершены ✅, осталось 5-8)

**Прогресс:**
- ✅ Шаг 1: Модели для TDLib positions (ChatList, ChatPosition)
- ✅ Шаг 2: Фильтрация архивных в ChannelMessageSource
- ✅ Шаг 3: E2E manual + Research - обнаружены 7 edge cases
- ✅ Шаг 4: Unit тесты на модели - 30 новых тестов GREEN (188/188 passed)
- ⏳ Шаг 5: Regression Component тесты (следующая задача)
- ⏳ Шаги 6-8: TSan, финальная проверка, рефлексия

**Следующая задача:** Regression Component тесты - архивный канал НЕ попадает в fetchUnreadMessages()
