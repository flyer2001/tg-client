...
3. **[DEV-4] Автогенерация DoCC из тестов** - Скрипт для автоматической генерации документации (~4-7 часов)
...
> - [DEV-4: Автогенерация DoCC](#dev-4-автогенерация-docc-документации-из-тестов) — автоматизация документации
